...
var puzzles = {
  ...
  description:
    "Performing Sustainable CoEvolution (PSC). Developed upon CoLaboArthon, DialoGame, and CoEvoLudens formats)",
  sudo: {
    offer: false,
    install: false,
    build: false,
...
var symlinks = [
  ...
  {
    from:
      variables.ANGULAR_BUILD_PACKAGES_FOLDER + "node_modules/@angular-devkit",
