...
export class CWCService {
  ...
  */
  ...
  getCWCs(): Observable<any[]> {
    ...
    return this.knalledgeNodeService.queryInMapofType(
      CWCService.mapId,
      CWC_TYPE
    ); //TODO: by User
  ...
  saveCWCs(cwcD: CWCData): Observable<any> {
    ...
    let that = this;
    this.knalledgeEdgeService
      .destroyByTypeByUser(CWC_TYPE, user_id)
      .subscribe(function(data: any) {
        console.log("oldCWCEdgesDeleted", data);

        that.knalledgeNodeService
          .destroyByTypeByUser(CWC_TYPE, user_id)
          .subscribe(function(data: any) {
              ...
              that.knalledgeNodeService
                ...
                .subscribe(function(node: KNode) {
                  ...
                  that.knalledgeEdgeService
                    .create(cwcEdge)
                    .subscribe(that.cwcESaved.bind(that));
                });
            }
          });
      });
