...
var MapVisualizationTree =  knalledge.MapVisualizationTree = function(dom, mapStructure, configTransitions, configTree, configNodes, configEdges, rimaUserService){
	this.dom = dom;
...
MapVisualizationTree.prototype.getDom = function(){
	return this.dom;
};

MapVisualizationTree.prototype.setDomSize = function(maxX, maxY){
...
MapVisualizationTree.prototype.setScales = function(){
	// var that = this;
...
MapVisualizationTree.prototype.positionToDatum = function(datum) {
...
MapVisualizationTree.prototype.updateName = function(nodeView){
...
MapVisualizationTree.prototype.updateNodeDimensions = function(){
	if(!this.configNodes.html.show) return;
	// var that = this;
