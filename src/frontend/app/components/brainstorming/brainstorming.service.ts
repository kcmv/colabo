...
export class BrainstormingService {
    ...
    private collaboPluginsService:any=null;
  ...
  constructor(
      ...
      // , @Inject('CollaboPluginsService') private collaboPluginsService: CollaboPluginsService
        ...
        //         this.brainstormingPluginInfo.references.map.$resolved = true;
        //         resolve(this.brainstormingPluginInfo.references.map);
        //         // reject('not allowed');
        //     };
        // });
        //
        ...
        //         this.brainstormingPluginInfo.apis.map.$resolved = true;
        //         resolve(this.brainstormingPluginInfo.apis.map);
        //         // reject('not allowed');
        //     };
        // });
        //
