...
export class Map{
	...
	GlobalEmittersArrayService:any;
	...
	*/
	constructor(
		...
		this.GlobalEmittersArrayService = this.injector.get('collaboPlugins.globalEmitterServicesArray');

		this.GlobalEmittersArrayService.register(this.knalledgeNodeTypeChanged);
		this.GlobalEmittersArrayService.get(this.knalledgeNodeTypeChanged).subscribe('Map', this.nodeTypeChanged.bind(this));

		this.GlobalEmittersArrayService.register(this.knalledgeNodeCreatorChanged);
		this.GlobalEmittersArrayService.get(this.knalledgeNodeCreatorChanged).subscribe('Map', this.nodeCreatorChanged.bind(this));
