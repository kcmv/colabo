...
*/
export class KnalledgeViewComponent implements OnInit, OnDestroy{
  ...
  private initKnalledgeMap(){
    ...
    // $element.find(".knalledge_map_container").get(0);
    var knalledgeMapDomVisualContainerD3 = d3.select(knalledgeMapDomVisualContainer);
  ...
  private registerToGlobalEventsAfterInit(){
    this.subscriptions.push(this.GlobalEmitterServicesArray.get(this.KnRealTimeNodeCreatedEvent).subscribe('knalledgeMap', this.knalledgeMap.processExternalChangesInMap.bind(this.knalledgeMap)));
    this.subscriptions.push(this.GlobalEmitterServicesArray.get(this.KnRealTimeNodeUpdatedEvent).subscribe('knalledgeMap', this.knalledgeMap.processExternalChangesInMap.bind(this.knalledgeMap)));
    this.subscriptions.push(this.GlobalEmitterServicesArray.get(this.KnRealTimeNodeDeletedEvent).subscribe('knalledgeMap', this.knalledgeMap.processExternalChangesInMap.bind(this.knalledgeMap)));

    this.subscriptions.push(this.GlobalEmitterServicesArray.get(this.KnRealTimeEdgeCreatedEvent).subscribe('knalledgeMap', this.knalledgeMap.processExternalChangesInMap.bind(this.knalledgeMap)));
    this.subscriptions.push(this.GlobalEmitterServicesArray.get(this.KnRealTimeEdgeUpdatedEvent).subscribe('knalledgeMap', this.knalledgeMap.processExternalChangesInMap.bind(this.knalledgeMap)));
    this.subscriptions.push(this.GlobalEmitterServicesArray.get(this.KnRealTimeEdgeDeletedEvent).subscribe('knalledgeMap', this.knalledgeMap.processExternalChangesInMap.bind(this.knalledgeMap)));
  }
  ...
  private registerToGlobalEvents(){
    ...
    this.GlobalEmitterServicesArray.register(this.changeKnalledgePropertyEvent);
    this.GlobalEmitterServicesArray.register(this.knalledgeMapUpdateEvent);
    this.GlobalEmitterServicesArray.register(this.mapEntitySelectedEvent);
    this.GlobalEmitterServicesArray.register(this.changeKnalledgeRimaEvent);
    ...
    this.GlobalEmitterServicesArray.register(this.KnRealTimeNodeCreatedEvent);
    this.GlobalEmitterServicesArray.register(this.KnRealTimeNodeDeletedEvent);
    this.GlobalEmitterServicesArray.register(this.KnRealTimeNodeUpdatedEvent);

    this.GlobalEmitterServicesArray.register(this.KnRealTimeEdgeCreatedEvent);
    this.GlobalEmitterServicesArray.register(this.KnRealTimeEdgeUpdatedEvent);
    this.GlobalEmitterServicesArray.register(this.KnRealTimeEdgeDeletedEvent);

    this.GlobalEmitterServicesArray.register(this.modelLoadedEvent);

    this.GlobalEmitterServicesArray.register(this.knalledgePropertyChangedEvent);
    this.GlobalEmitterServicesArray.register(this.knalledgePropertyChangedFinishedEvent);

    this.GlobalEmitterServicesArray.register(this.behaviourChangedEvent);

    this.GlobalEmitterServicesArray.register(this.nodeMediaClickedEvent);
  ...
  delayedFunc() {
    ...
    */
    ...
    this.subscriptions.push(this.GlobalEmitterServicesArray.get(this.knalledgePropertyChangedEvent).subscribe('knalledgeMap', function(nodeContentChanged) {
      knalledgePropertyCallback(nodeContentChanged, false);
    }));

    this.subscriptions.push(this.GlobalEmitterServicesArray.get(this.knalledgePropertyChangedFinishedEvent).subscribe('knalledgeMap', function(nodeContentChanged) {
    ...
    this.subscriptions.push(this.GlobalEmitterServicesArray.get(this.knalledgeMapUpdateEvent).subscribe('knalledgeMap', knalledgeMapUpdate));

    this.GlobalEmitterServicesArray.register(this.viewConfigChangedEvent);
    this.subscriptions.push(this.GlobalEmitterServicesArray.get(this.viewConfigChangedEvent).subscribe('knalledgeMap', viewConfigChanged));
    ...
    this.subscriptions.push(this.GlobalEmitterServicesArray.get(this.behaviourChangedEvent).subscribe('knalledgeMap', behaviourChanged));
    ...
    if (this.KnAllEdgeRealTimeService) {
      ...
      var realTimeviewConfigChanged = function(eventName, msg) {
        ...
        if (msg.path == 'policyConfig.broadcasting.enabled' && msg.value) { // Highlander: There can be only one!
          this.KnalledgeMapPolicyService.provider.config.broadcasting.enabled = false;
        }

        if (!this.KnalledgeMapPolicyService.provider.config.broadcasting.receiveVisualization) {
          return;
        }
        switch (msg.path) {
          ...
          case 'config.visualization.viewspec':
            this.KnalledgeMapViewService.provider.config.visualization.viewspec = this.config.visualization.viewspec = msg.value;
            break;
          case 'config.edges.orderBy':
            this.KnalledgeMapViewService.provider.config.edges.orderBy = this.config.edges.orderBy = msg.value;
            break;
      ...
      // this.subscriptions.push(GlobalEmitterServicesArray.get(broadcastingChangedEvent).subscribe('knalledgeMap', function() {
      // 	console.log("[knalledgeMap.controller::$on] event: %s", broadcastingChangedEvent);
      // 	// knalledgeMap.syncingChanged(); NOT USED ANY MORE
      // }));

    this.subscriptions.push(this.GlobalEmitterServicesArray.get(this.changeKnalledgeRimaEvent).subscribe('knalledgeMap',
      function(msg) {
    ...
    this.subscriptions.push(this.GlobalEmitterServicesArray.get(this.changeSelectedNodeEvent).subscribe('knalledgeMap', function(vkNode) {
