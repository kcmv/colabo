...
export class KMapClientInterface {
  ...
  constructor(
    ...
    private GlobalEmittersArrayService,
    ...
    this.GlobalEmittersArrayService.register(this.PRESENTER_CHANGED);
  }
  ...
  nodeMediaClicked(vkNode) {
    if (vkNode) {
      this.GlobalEmittersArrayService.get(this.nodeMediaClickedEvent).broadcast('knalledgeMap', vkNode);
    }
  }
  ...
  nodeSelected(vkNode, dom, selectionSource:string=null) {
    ...
    var processNodeSelected = function() {
      ...
      this.GlobalEmittersArrayService.get(this.changeKnalledgePropertyEvent).broadcast('knalledgeMap', nodeContent);
      this.GlobalEmittersArrayService.get(this.selectedNodeChangedEvent).broadcast('knalledgeMap', vkNode);
    }
  ...
  toggleModerator() {
    ...
    if (this.KnalledgeMapPolicyService && this.KnalledgeMapPolicyService.provider.config.moderating.enabled){
      if(window.confirm('Do you want to create a new session?')) {
        ...
        this.GlobalEmittersArrayService.register(SETUP_SESSION_REQUEST_EVENT);
        this.GlobalEmittersArrayService.get(SETUP_SESSION_REQUEST_EVENT).broadcast('KnalledgeMap');
      }
    }else{
  ...
  togglePresenter() {
    ...
    this.GlobalEmittersArrayService.get(this.PRESENTER_CHANGED)
  ...
  mapEntityClicked(mapEntity /*, mapEntityDom*/ ) {
    ...
    this.GlobalEmittersArrayService.get(this.mapEntitySelectedEvent).broadcast('knalledgeMap', mapEntity);
  }
