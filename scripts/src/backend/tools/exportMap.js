...
var mapId = process.argv[3] || "5d791568da853c1e2a3eab5a";
var rootNodeId = process.argv[4] || "5d791568da853c1e2a3eab5b";
...
db.on("open", function(callback) {
  ...
  var nodesEdgesReceived = function(nodes, edges) {
    console.log(
      "[nodesEdgesReceived] %d nodes **************** :",
      nodes.length
    );
    console.log(JSON.stringify(nodes));
    console.log(
      "[nodesEdgesReceived] %d edges **************** :",
      edges.length
    );
